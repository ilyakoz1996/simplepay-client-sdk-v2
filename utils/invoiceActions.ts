 ...
 */
export const combineInvoicesById = (
    invoices: ParsedContractInvoice[]
  ): ParsedContractInvoice[] => {
    ...
    invoices.forEach((invoice) => {
      ...
      if (
        !latestInvoices[invoice.invoiceId!] ||
        effectiveUpdatedAt! >
 ...
 */
export const parseEventArgsData = (type: any, invoice: any) => {
    return {
      invoiceId: invoice[1],
